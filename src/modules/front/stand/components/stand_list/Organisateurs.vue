...
<!--     <div class="container expo">
  ...
  <div class="container align-items-center">
    ...
    <div class="card-deck align-items-center d-flex justify-content-center">

      <div v-for='exposant in exposants' :key='exposant.id' class="flip-card align-items-center">
  ...
  data() {
    ...
    computed: {
        ...
        exposants() {
            ...
            return this.$store.getters.allOrganisateurs
        },
        currentExposant() {
            //console.log(this.$store.getters.allSponsorsOfficiels)
