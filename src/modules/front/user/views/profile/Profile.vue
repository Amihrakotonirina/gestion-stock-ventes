<template>
    <div class="main-content">
        ...
        <div class="card user-profile o-hidden mb-30">
            <div class="header-cover" :style="cssProps"></div>
                <div class="user-info">
                    <img class="profile-picture avatar-lg mb-2" src="@/assets/images/faces/amih.jpg" alt="">
                        <p class="m-0 text-24">Amih RAKOTONIRINA</p>
                        <p class="text-muted m-0">Développeur web</p>
            </div>
            <div class="card-body">
                <div>
                    <b-tabs content-class="mt-3" align="center">
                        <b-tab title="Journal" active>
...
export default {
  ...
  data() {
    return {
        cssProps: {
            backgroundImage: `url(${require('@/assets/images/cover-profile/qg-amikal.jpg')})`,
        }
    }
  }
}
