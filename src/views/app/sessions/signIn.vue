          ...
          <div class="col-md-6">
            <div class="p-4">
              ...
              <b-form @submit.prevent="formSubmit">
                <b-form-group label="Adresse mail" class="text-12">
                  <b-form-input
                ...
                <b-form-group label="Mot de passe" class="text-12">
                ...
                <b-button
                  ...
                  variant="primary mt-2"
                  class="btn-rounded"
                >Créer un compte e-rohy</b-button>
              </b-form>
...
export default {
  ...
  data() {
    return {
      email: "",
      password: "",
      bgImage: require("@/assets/images/background_by_gemmmm-T6.jpg"),
      logo: require("@/assets/images/logo.png"),
      signInImage: require("@/assets/images/img_phone.jpg"),
    };
  },
