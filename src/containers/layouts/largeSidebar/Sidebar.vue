      ...
      <div>
        <ul class="navigation-left">
          <li
            ...
            :data-submenu="true"
          >
            <router-link tag="a" class to="/admin/dashboards">
              <a class="nav-item-hold" href="#">
                <!--i class="nav-icon i-Bar-Chart"></i-->
                <b-icon icon="watch" scale="2" variant="secondary"></b-icon>
          ...
          <li
            ...
            class="nav-item"
            :class="{ active: selectedParentMenu == 'stands' }"
            data-item="stands"
          >
            <a class="nav-item-hold" href="#">
              <!--i class="nav-icon i-Monitor-Vertical"></i-->
                <b-icon icon="shop" scale="2" variant="secondary"></b-icon>
              <span class="nav-text">Mon stand</span>
            </a>
            <div class="triangle"></div>
          </li>
          ...
          <li
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'applications' }"
            data-item="applications"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Folder"></i>
              <span class="nav-text">Mes applications</span>
            </a>
            <div class="triangle"></div>
          </li>
          ...
          <li
            @mouseenter="toggleSubMenu"
            class="nav-item"
            :class="{ active: selectedParentMenu == 'enterprise-kits' }"
            data-item="enterprise-kits"
          >
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Management"></i>
              <span class="nav-text">Kits entreprises</span>
            </a>
            <div class="triangle"></div>
          </li>
...
<!-- ======================== start stands submenu ======================== -->
<!-- ======================== start stands submenu ======================== -->
        <ul
          class="childNav d-none"
          data-parent="stands"
          :class="{ 'd-block': selectedParentMenu == 'stands' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/admin/stands">
              <i class="nav-icon i-Home1"></i>
              <span class="item-name">Information générale</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/accueil">
          ...
          <li class="nav-item">
            <router-link tag="a" class to="/accueil">
              ...
              <span class="item-name">Liens externes</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/accueil">
              <i class="nav-icon i-Find-User"></i>
              <span class="item-name">Design stand</span>
            </router-link>
          </li>
        </ul>
...
<!-- ======================== ===================== ======================== -->
<!-- ====================== start applications submenu ====================== -->
<!-- ======================== ===================== ======================== -->
        <ul
          class="childNav d-none"
          data-parent="sessions"
          :class="{ 'd-block': selectedParentMenu == 'applications' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/admin/user/profile">
              <i class="nav-icon i-Checked-User"></i>
              <span class="item-name">Profile</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/admin/user/resume">
              <i class="nav-icon i-Add-User"></i>
              <span class="item-name">CV</span>
            </router-link>
          </li>
          <li class="nav-item">
            <router-link tag="a" class to="/admin/user/visit-card">
              <i class="nav-icon i-ID-3"></i>
              <span class="item-name"> Carte de visite</span>
            </router-link>
          </li>
        </ul>
...
<!-- ======================== begin enterprise-kits submenu ======================== -->
<!-- ======================== begin enterprise-kits submenu ======================== -->
        <ul
          class="childNav d-none"
          data-parent="enterprise-kits"
          :class="{ 'd-block': selectedParentMenu == 'enterprise-kits' }"
        >
          <li class="nav-item">
            <router-link tag="a" class to="/admin/kits-entreprises/business-plan">
              <i class="nav-icon i-Library"></i>
              <span class="item-name">Business plan</span>
            </router-link>
          </li>
        </ul>
<!-- ======================== end enterprise-kits submenu ======================== -->
<!-- ======================== end enterprise-kits submenu ======================== -->
      </div>
    </vue-perfect-scrollbar>
    <div
